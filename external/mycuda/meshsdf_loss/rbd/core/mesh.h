...
// creates a smooth background mesh suitable for rendering / lighting objects against
// zero for positive z, and grows cubically past -zoffset
// scale controls how steep the wall is, zoffset is offset from 0 to start climbing
// size is dimensions of the underlying grid mesh, dimx, dimz are the resolution
