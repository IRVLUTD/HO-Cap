...
class ManoLayer(Module):
    ...
    def __init__(
        ...
        ncomps=6,
        side="right",
        mano_root=os.path.join(os.path.dirname(__file__), "../mano/models"),
        use_pca=True,
        ...
        self.register_buffer(
            # "th_betas", torch.Tensor(np.array(smpl_data["betas"].r)).unsqueeze(0)
            "th_betas",
        ...
        self.register_buffer(
            # "th_posedirs", torch.Tensor(np.array(smpl_data["posedirs"].r))
            "th_posedirs",
        ...
        self.register_buffer(
            # "th_weights", torch.Tensor(np.array(smpl_data["weights"].r))
            "th_weights",
        ...
        self.register_buffer(
            ...
            "th_faces",
            torch.Tensor(smpl_data["f"].astype(np.int64)).long(),
        )
